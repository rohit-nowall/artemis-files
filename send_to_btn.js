...
function queryOne()
{
    ...
    connectionSrc.query("SELECT * from kyc_status WHERE send_status = 'no'", function(error, results, fields)
    {
        connectionSrc.end();
